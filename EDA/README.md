...
> detection balance, toxin coverage, commodity/location coverage, seasonality,
> and weather availability. This showed that only a small number of toxins have
> enough detected examples for responsible model training, so the prediction
> feature is framed as sampling-priority recommendation instead of full safety
> prediction.
