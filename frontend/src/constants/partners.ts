...
export const partnerLocations: Record<string, { lat: number; lng: number; dx?: number; dy?: number }> = {
  Thailand: { lat: 14.0, lng: 100.6, dx: -58, dy: 6 },
  "United States": { lat: 43.9, lng: -120.5, dx: -28, dy: 18 },
  "United Kingdom": { lat: 53.0, lng: -1.5, dx: 50, dy: -28 },
  Italy: { lat: 42.8, lng: 12.8, dx: 20, dy: 34 },
  Austria: { lat: 47.6, lng: 14.1, dx: 72, dy: 10 },
  China: { lat: 35.0, lng: 105.0, dx: -44, dy: -30 },
  Japan: { lat: 36.2, lng: 138.3, dx: 52, dy: -28 },
  Singapore: { lat: 1.35, lng: 103.8, dx: 24, dy: 18 },
  Ireland: { lat: 53.3, lng: -8.0, dx: -44, dy: -24 },
  France: { lat: 46.5, lng: 2.5, dx: -54, dy: 26 },
  Belgium: { lat: 50.6, lng: 4.5, dx: 24, dy: -12 },
  Canada: { lat: 56.0, lng: -106.0, dx: 26, dy: -18 },
  Nepal: { lat: 28.2, lng: 84.0, dx: -80, dy: -8 },
  Paraguay: { lat: -23.4, lng: -58.4 },
  "Hong Kong": { lat: 22.3, lng: 114.2, dx: 62, dy: -4 },
  "South Korea": { lat: 36.5, lng: 127.8, dx: 22, dy: 14 },
  Vietnam: { lat: 16.5, lng: 107.8, dx: 12, dy: 34 },
  Malaysia: { lat: 3.1, lng: 101.7, dx: -60, dy: 6 },
  Indonesia: { lat: -2.5, lng: 118.0, dx: 48, dy: 34 },
  Myanmar: { lat: 21.0, lng: 96.0, dx: -42, dy: -24 },
};
