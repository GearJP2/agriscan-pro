                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    },
                    {
                      ...
                      descEn: 'No EU threshold reference exists for this toxin type (e.g. AFG1, AFG2, AFM1). The result remains unclassified for review.',
                      descTh: 'ไม่มีเกณฑ์ EU สำหรับสารพิษชนิดนี้ (เช่น AFG1, AFG2, AFM1) ผลจึงเป็น unclassified เพื่อรอการตรวจทาน',
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-border/30">
                          {[
                            ...
                            { code: 'FB1', name: 'Fumonisin B1', low: 2000, high: 4000, noteEn: 'EU guidance value for total fumonisins', note: 'ค่าแนะนำ EU สำหรับ Fumonisin รวม' },
                            { code: 'T-2', name: 'T-2 Toxin', low: 100, high: 200, noteEn: '', note: '' },
