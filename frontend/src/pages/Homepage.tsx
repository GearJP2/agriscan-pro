  ...
  return (
    <div className="min-h-screen bg-white dark:bg-background flex flex-col">
      <main className="flex-grow flex flex-col">
        ...
        <section className="relative w-full max-w-container-max mx-auto px-gutter pt-[60px] pb-[80px] flex flex-col lg:flex-row items-center lg:gap-32">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute top-[10%] -left-[10%] glass-panel p-[16px] rounded-xl z-20 shadow-lg border border-white/40 hidden md:block text-left"
            >
            ...
            {blogs.map((b, i) => (
              <motion.article
                ...
                className={cn(
                  ...
                  current === i ? "border-blue-600 bg-slate-50 dark:bg-card/40 shadow-xl" : "hover:shadow-2xl"
                )}
              >
          ...
          <div className="grid grid-cols-1 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-white dark:bg-card rounded-2xl border border-blue-600/20 p-10 flex flex-col md:flex-row justify-between items-center relative overflow-hidden group shadow-sm hover:shadow-md transition-shadow"
              >
                ...
                <div className="max-w-2xl text-left">
                  <span className="font-label-sm text-label-sm text-slate-900 dark:text-white mb-4 block uppercase tracking-widest">{step.id} {step.label}</span>
                  <h3 className="font-headline-md text-headline-md text-slate-900 dark:text-white mb-2">{step.title}</h3>
                  <p className="font-body-md text-body-md text-slate-500 dark:text-slate-400 leading-relaxed">{step.desc}</p>
                </div>
                <motion.div 
        ...
        <section className="w-full py-16 bg-white dark:bg-background relative overflow-hidden">
          <div className="max-w-container-max mx-auto px-gutter">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="glass-panel p-8 lg:p-10 rounded-[40px] flex flex-col lg:flex-row lg:items-stretch gap-10 lg:gap-16 overflow-hidden relative shadow-2xl border-white/40 dark:border-slate-800/50"
            >
              ...
              <div className="flex-[1.2] text-left py-2">
                ...
                <h2 className="font-headline-md text-headline-md text-slate-900 dark:text-white mb-4">Open to researchers and collaborators.</h2>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
                  <Link 
                    to="/doc" 
                    className="w-full sm:w-auto bg-emerald-950 text-white font-bold text-[13px] px-10 py-4 rounded-full flex items-center justify-center gap-2 hover:bg-emerald-900 transition-all group/btn shadow-lg"
                  >
                    Contact Us
                  ...
                  <Link 
                    to="/doc" 
                    className="w-full sm:w-auto border-2 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-bold text-[13px] px-10 py-4 rounded-full flex items-center justify-center gap-2 hover:bg-slate-100 dark:hover:bg-slate-900 transition-all"
                  >
                    Documentation
                  </Link>
                </div>
                ...
                <div className="pt-8 border-t border-slate-100 dark:border-slate-800/50">
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                      ...
                      >
                        <p className="text-[20px] font-bold text-slate-900 dark:text-white leading-none">{s.val}</p>
        ...
        <motion.section 
          ...
          viewport={{ once: true }}
          className="w-full py-20 border-t-2 border-blue-600/20 bg-slate-50/20 dark:bg-background/40 backdrop-blur-sm"
        >
          <div className="max-w-container-max mx-auto px-gutter flex flex-col md:flex-row items-center justify-center gap-12 text-center md:text-left">
            ...
            <div className="max-w-xl">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-8 gap-y-4 text-slate-500">
                ...
                <div className="text-sm border-l border-slate-200 dark:border-slate-800 pl-8 hidden md:flex items-center gap-2">
