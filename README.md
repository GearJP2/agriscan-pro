...
| :--- | :--- | :--- |
| **Elastic Beanstalk**| Web/API Tier | Python 3.12 running on AL2023 (`agriscan-pro-prod`) |
...
- `ALLOWED_HOSTS`: `api.yourdomain.com,agriscan-pro-prod.us-east-1.elasticbeanstalk.com`
